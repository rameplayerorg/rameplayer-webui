(function() {
    ...
    angular
        ...
        .controller('FactoryResetModalController', FactoryResetModalController);

    FactoryResetModalController.$inject = ['logger', '$scope', '$timeout', '$uibModalInstance', 'dataService',
        'statusService', 'toastr', '$window', '$translate'];

    function FactoryResetModalController(logger, $scope, $timeout, $uibModalInstance, dataService,
                                    statusService, toastr, $window, $translate) {
        var vm = this;
